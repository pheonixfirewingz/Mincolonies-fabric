...
import cf.pheonixfirewingz.minecolonies.MinecoloniesItems;
import cf.pheonixfirewingz.minecolonies.crafting.ItemStorage;
import cf.pheonixfirewingz.minecolonies.entity.citizen.AbstractEntityCitizen;
...
public final class ItemStackUtils
{
     ...
     */
    public static final Predicate<ItemStack> IS_COMPOST = stack -> !stack.isEmpty() && stack.getItem() == MinecoloniesItems.compost;
     ...
     */
    @Nullable
    public static Entity getEntityFromEntityInfoOrNull(final CompoundTag entityData, final World world)
    {
        try
        {
     ...
     */
    public static List<ItemStorage> getListOfStackForEntityInfo(final CompoundTag entityData, final World world, final Entity placer)
    {
        if (entityData != null)
        {
     ...
     * @return a list of stacks.
     */
    public static List<ItemStorage> getListOfStackForEntityInfo(final CompoundTag entityData, final World world, final AbstractEntityCitizen placer)
    {
    ...
    */
    ...
    /**
     * Update method to allow for easy readNbting the ItemStack data from NBT.
     *
     * @param compound The compound to readNbt from.
