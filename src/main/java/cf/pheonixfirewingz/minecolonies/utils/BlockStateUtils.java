...
public class BlockStateUtils
{
    ...
    public static boolean stateEqualsStateInPropertyByName(@NotNull final BlockState state1, @NotNull final BlockState state2, @NotNull final String propertyName)
    {
        ...
        if (propertyOne != null && state2.contains(propertyOne))
        {
        ...
        if (propertyOne != null && propertyTwo != null && state1.contains(propertyOne) && state2.contains(propertyTwo))
        {
    ...
    {
        Property<?> property = propertyBlockMap.get(state.getBlock().getTranslationKey().toString() + ":" + name);
        ...
        else
        {
            ...
            if (property != null)
            {
                propertyBlockMap.put(state.getBlock().getTranslationKey().toString() + ":" + name, property);
            }
            return property;
        }
    }
    ...
    {
        if (!state1.contains(prop) || !state2.contains(prop))
        {
            return state1 == state2;
        }
