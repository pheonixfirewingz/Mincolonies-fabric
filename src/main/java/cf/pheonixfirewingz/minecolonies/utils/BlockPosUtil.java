...
public final class BlockPosUtil
{
    ...
    public static BlockPos getRandomPosition(final World world, final BlockPos currentPosition, final BlockPos def, final int minDist, final int maxDist)
    {
        ...
        while (pos == null
                 ...
                 || (!world.isAir(pos) || !world.isAir(pos.up())))
        {
    ...
    public static BlockPos findLand(final BlockPos blockPos, final World world)
    {
        ...
        while (top >= bot)
        {
            ...
            if (block instanceof AirBlock && world.isSkyVisibleAllowingSea(tempPos))
            {
                top = mid - 1;
                foundland = tempPos;
            }
    ...
    public static double getValidHeight(@NotNull final Vector3d position, @NotNull final World world)
    {
        ...
        while (returnHeight >= 1 && world.isAir(new BlockPos(MathHelper.floor(position.x),
          (int) returnHeight,
     ...
     */
    public static BlockEntity getTileEntity(@NotNull final World world, @NotNull final BlockPos pos)
    {
    ...
    {
        return new BlockPos(MathHelper.floor(entity.getBlockX()), MathHelper.floor(entity.getBlockY()), MathHelper.floor(entity.getBlockZ()));
    }
     ...
     * @return the enum BlockRotation.
     */
    public static BlockRotation getRotationFromRotations(final int rotations)
    {
        switch (rotations)
        {
            case ROTATE_ONCE:
     ...
     */
    public static BlockPos findAround(final BlockView world, final BlockPos start, final int vRange, final int hRange, final Predicate<BlockState> predicate)
    {
