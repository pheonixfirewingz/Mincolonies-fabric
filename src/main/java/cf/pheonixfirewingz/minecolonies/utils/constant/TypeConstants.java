...
import cf.pheonixfirewingz.minecolonies.colony.requestsystem.data.*;
import cf.pheonixfirewingz.minecolonies.colony.requestsystem.factory.FactoryVoidInput;
import cf.pheonixfirewingz.minecolonies.colony.requestsystem.location.ILocation;
import cf.pheonixfirewingz.minecolonies.colony.requestsystem.requestable.*;
import cf.pheonixfirewingz.minecolonies.colony.requestsystem.requestable.crafting.*;
import cf.pheonixfirewingz.minecolonies.colony.requestsystem.requestable.deliveryman.*;
...
import cf.pheonixfirewingz.minecolonies.colony.requestsystem.token.*;
...
public class TypeConstants
{
    ...
    public static final TypeToken<RTag>              TAG_REQUEST      = TypeToken.of(RTag.class);
