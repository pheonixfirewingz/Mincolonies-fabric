...
import cf.pheonixfirewingz.minecolonies.colony.IColonyTagCapability;
...
public class ChunkLoadStorage
{
    ...
    public ChunkLoadStorage(final CompoundTag compound)
    {
        ...
        this.dimension = new Identifier(compound.getString(TAG_DIMENSION));
     ...
     */
    public ChunkLoadStorage(final int colonyId, final long xz, final boolean add, final Identifier dimension, final boolean owning)
    {
     ...
     */
    public ChunkLoadStorage(final int colonyId, final long xz, final Identifier dimension, final BlockPos building)
    {
        this.xz = xz;
        this.dimension = dimension;
