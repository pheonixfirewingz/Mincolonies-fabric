package cf.pheonixfirewingz.minecolonies.colony.requestsystem.factory;
...
public interface IFactoryController
{
     ...
     */
    <Output extends Object> void serialize(@NotNull final PacketByteBuf buffer, @NotNull final Output object) throws IllegalArgumentException;
     ...
     */
    <Output> Output deserialize(@NotNull final PacketByteBuf buffer) throws IllegalArgumentException;
