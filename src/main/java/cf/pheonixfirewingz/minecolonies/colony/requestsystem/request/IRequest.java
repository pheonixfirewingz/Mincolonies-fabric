package cf.pheonixfirewingz.minecolonies.colony.requestsystem.request;

import cf.pheonixfirewingz.minecolonies.colony.IColonyView;
import cf.pheonixfirewingz.minecolonies.colony.requestsystem.manager.*;
...
public interface IRequest<R extends IRequestable>
{
     ...
     *
     * @return The ItemStacks that the Deliveryman transports around.  means no delivery possible.
     */
    @NotNull
    ...
    /**
     * Method used to get a {@link Text} that can be displayed to the Player and describes the request in short. Should represent the request, in case the player needs to
     * fulfill it, or information about this request is required.
     *
     * @return The text that describes this Request.
     */
    @NotNull
    Text getShortDisplayString();

    /**
     * Method used to get a {@link Text} that can be displayed to the Player and describes so that the player can complete it. Should represent the request, in case the
     * player needs to fulfill it, or information about this request is required.
     *
     * @return The text that describes this Request.
     */
    @NotNull
    Text getLongDisplayString();
     ...
     */
    List<MutableText> getResolverToolTip(IColonyView colony);
