package cf.pheonixfirewingz.minecolonies.colony.requestsystem;
...
import cf.pheonixfirewingz.minecolonies.utils.constant.Suppression;
...
public final class StandardFactoryController implements IFactoryController
{
    ...
    public <OUTPUT> OUTPUT deserialize(@NotNull final CompoundTag compound) throws IllegalArgumentException
    {
        ...
        {
            Minecolonies.logError(throwable.getMessage());
            return null;
        }
    }
    ...
    @Override
    public <OUTPUT> void serialize(@NotNull final PacketByteBuf buffer, @NotNull final OUTPUT object) throws IllegalArgumentException
    {
        final IFactory<?, OUTPUT> factory = getFactoryForOutput((TypeToken<? extends OUTPUT>) TypeToken.of(object.getClass()));
    ...
    @Override
    public <OUTPUT> OUTPUT deserialize(@NotNull final PacketByteBuf buffer) throws IllegalArgumentException
    {
