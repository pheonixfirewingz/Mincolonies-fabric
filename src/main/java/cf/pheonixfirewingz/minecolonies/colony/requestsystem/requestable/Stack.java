...
public class Stack implements IConcreteDeliverable
{
    ...
    {
        this(stack, true, true, false, ItemStackUtils.EMPTY, Math.min(stack.getCount(), stack.getMaxCount()), Math.min(stack.getCount(), stack.getMaxCount()));
    }
     ...
     */
    public static void serialize(final IFactoryController controller, final PacketByteBuf buffer, final Stack input)
    {
     ...
     * @return the deliverable.
     */
    public static Stack deserialize(final IFactoryController controller, final PacketByteBuf buffer)
    {
