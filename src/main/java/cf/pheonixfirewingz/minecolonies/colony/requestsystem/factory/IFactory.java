...
public interface IFactory<Input, Output>
{
     ...
     */
    @NotNull
    void serialize(@NotNull IFactoryController controller, @NotNull Output output, PacketByteBuf packetBuffer);
     ...
     */
    @NotNull
    Output deserialize(@NotNull IFactoryController controller, @NotNull PacketByteBuf buffer) throws Throwable;
}
