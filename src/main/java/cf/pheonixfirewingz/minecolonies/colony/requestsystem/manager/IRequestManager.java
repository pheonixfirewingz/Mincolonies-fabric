package cf.pheonixfirewingz.minecolonies.colony.requestsystem.manager;

import cf.pheonixfirewingz.minecolonies.colony.requestsystem.data.IDataStoreManager;
import cf.pheonixfirewingz.minecolonies.colony.requestsystem.factory.IFactoryController;
import cf.pheonixfirewingz.minecolonies.colony.requestsystem.request.*;
import cf.pheonixfirewingz.minecolonies.colony.requestsystem.requestable.IRequestable;
import cf.pheonixfirewingz.minecolonies.colony.requestsystem.requester.IRequester;
import cf.pheonixfirewingz.minecolonies.colony.requestsystem.resolver.*;
import cf.pheonixfirewingz.minecolonies.colony.requestsystem.resolver.player.IPlayerRequestResolver;
import cf.pheonixfirewingz.minecolonies.colony.requestsystem.resolver.retrying.IRetryingRequestResolver;
 ...
 */
public interface IRequestManager extends INBTSerializable<CompoundTag>, ITickableTileEntity
{
    ...
    /**
     * serialize this request manager to the give {@link PacketByteBuf}
     *
     * @param controller the controller.
     * @param buffer     the {@link PacketByteBuf} to serialize to.
     */
    void serialize(final IFactoryController controller, final PacketByteBuf buffer);

    /**
     * deserialize this request manager from the give {@link PacketByteBuf}
     *
     * @param controller the controller.
     * @param buffer     the {@link PacketByteBuf} to deserialize from.
     */
    void deserialize(final IFactoryController controller, final PacketByteBuf buffer);
}
