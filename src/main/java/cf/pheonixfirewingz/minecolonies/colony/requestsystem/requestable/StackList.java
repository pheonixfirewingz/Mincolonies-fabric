...
import static cf.pheonixfirewingz.minecolonies.utils.constant.TranslationConstants.LIST_REQUEST_DISPLAY_STRING;
...
public class StackList implements IConcreteDeliverable
{
      ...
      final int minCount)
    {
        ...
        for (final ItemStack stack : stacks)
        {
            ...
            tempStack.setCount(Math.min(tempStack.getCount(), tempStack.getMaxCount()));
    ...
    public static StackList deserialize(final IFactoryController controller, final CompoundTag compound)
    {
        ...
        for (int i = 0; i < neededResTagList.size(); ++i)
        {
            ...
            stacks.add(ItemStack.fromNbt(neededRes));
        }
     ...
     */
    public static void serialize(final IFactoryController controller, final PacketByteBuf buffer, final StackList input)
    {
     ...
     * @return the deliverable.
     */
    public static StackList deserialize(final IFactoryController controller, final PacketByteBuf buffer)
    {
        final List<ItemStack> stacks = new ArrayList<>();
