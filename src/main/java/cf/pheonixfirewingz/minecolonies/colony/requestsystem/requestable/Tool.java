...
public class Tool implements IDeliverable
{
    ...
    public static Tool deserialize(final IFactoryController controller, final CompoundTag nbt)
    {
        ...
        final ItemStack result = ItemStack.fromNbt(nbt.getCompound(NBT_RESULT));
     ...
     */
    public static void serialize(final IFactoryController controller, final PacketByteBuf buffer, final Tool input)
    {
     ...
     */
    public static Tool deserialize(final IFactoryController controller, final PacketByteBuf buffer)
    {
